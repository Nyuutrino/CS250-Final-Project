 ...
 * 
 */
public class Corner extends Barrier {
	...
	public void draw(Graphics2D g2) {
		...
		if (dir.getDirection() == Direction.EAST) {
			...
			g2.fillRect(x + tileWidth * GameConfig.tileSize, y - tileWidth * GameConfig.tileSize, thickness, tileWidth * GameConfig.tileSize);
		}
		if (dir.getDirection() == Direction.WEST) {
			//West
